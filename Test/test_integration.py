...
from website_monitor.main import perform_check
...
class TestPerformCheck(unittest.TestCase):
    ...
    def test_output(self):
        changed = perform_check(copy.deepcopy(self.fake_website_data), verbose=False)
